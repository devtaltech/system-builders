  ...
  head: () => ({
    meta: [
      { title: "Contact — Let's talk. No pressure. · DeVTAL" },
      {
        name: "description",
        content:
          "WhatsApp us, email us, or fill the short form. Reply within 24 hours. Budgets from ₹10k.",
      },
      { property: "og:title", content: "Contact — DeVTAL" },
      {
        property: "og:description",
        content: "Real humans. Real reply times. No pricing gatekeeping.",
      },
    ],
  }),
  component: Contact,
    ...
    <div className="relative">
      ...
      <div className="relative mx-auto max-w-6xl px-6 py-20">
        ...
        <p className="mt-3 max-w-xl text-lg text-muted-foreground">
          Tell us what you're trying to build (or fix). We'll reply within 24 hours — usually
          faster.
        </p>
        ...
        <div className="mt-14 grid gap-10 md:grid-cols-5">
            ...
            {sent ? (
              <div className="rounded-2xl border border-cyan/40 bg-cyan/5 p-8">
                ...
                <p className="mt-2 text-muted-foreground">
                  We'll be in touch on WhatsApp or email shortly.
                </p>
              </div>
            ) : (
              <form
              ...
              >
                ...
                <div>
                  <label
                    className="mb-1 block text-xs font-display uppercase tracking-wider text-muted-foreground"
                    htmlFor="msg"
                  >
                ...
                <p className="text-xs text-muted-foreground">
                  No "submit to get pricing" gatekeeping. Just a conversation.
                </p>
              </form>
            )}
          </div>
          ...
          <aside className="md:col-span-2 space-y-4">
            <a
              ...
              className="lift block rounded-2xl border border-hairline bg-card p-6"
            >
              <div className="flex items-center gap-3">
                <span className="grid h-10 w-10 place-items-center rounded-full bg-[#25D366]/15 text-lg">
                  📱
                </span>
                <div>
                  ...
                  <p className="font-display text-lg">+91 9719203955</p>
                </div>
              </div>
            </a>
            <div className="lift rounded-2xl border border-hairline bg-card p-6">
              <div className="flex items-center gap-3">
                <span className="grid h-10 w-10 place-items-center rounded-full bg-cyan/15">
                  ⏱️
                </span>
                <div>
                  <p className="font-display text-sm uppercase tracking-wider text-muted-foreground">
            ...
            <div className="lift rounded-2xl border border-hairline bg-card p-6">
              <div className="flex items-center gap-3">
                <span className="grid h-10 w-10 place-items-center rounded-full bg-pink/15">
                  💰
                </span>
                <div>
                  <p className="font-display text-sm uppercase tracking-wider text-muted-foreground">
                  ...
                  <p className="font-display text-lg">From ₹1k. Yes really.</p>
                </div>
              </div>
            </div>
          </aside>
