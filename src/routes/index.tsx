  ...
  head: () => ({
    meta: [
      { title: "DeVTAL — Your business isn't a website. It's a system." },
      {
        name: "description",
        content:
          "From one-page sites to full business management. One team. No vendor chaos. No retainer traps.",
      },
      { property: "og:title", content: "DeVTAL — Build the system, not just the website" },
      {
        property: "og:description",
        content: "We build and maintain websites + business systems. Real humans. Honest pricing.",
      },
    ],
  }),
  component: Home,
    ...
    <>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-24 md:py-36">
          ...
          >
            <span className="badge-honest">
              <span className="h-1.5 w-1.5 rounded-full bg-cyan animate-pulse" /> Open for 2 of 3
              slots — May
            </span>
          </motion.div>
          ...
          >
            <Link
              to="/contact"
              className="wiggle group inline-flex items-center gap-2 rounded-full bg-cyan px-6 py-3.5 font-display font-semibold text-background hover:shadow-glow-cyan"
            >
            ...
            <a
              href="#how-we-think"
              className="inline-flex items-center gap-2 rounded-full border border-hairline px-6 py-3.5 font-display text-foreground hover:border-cyan/60"
            >
              See how we think ↓
            </a>
          </motion.div>
          ...
          <motion.div {...fadeUp} className="mt-12 flex flex-wrap gap-2">
            {[
              ...
              <span key={b} className="badge-honest">
                ✦ {b}
              </span>
            ))}
          </motion.div>
        ...
        <div className="relative border-y border-hairline bg-surface/40">
          <div className="mx-auto max-w-7xl px-6 py-5">
            <p className="text-xs uppercase tracking-[0.2em] text-muted-foreground">
              Trusted by founders who were tired of bad agencies
            </p>
            <div className="mt-4 flex flex-wrap items-center gap-x-10 gap-y-3 opacity-70">
              {["Kettle&Co", "Nimbus HR", "Patio Real Estate", "RootSchool", "Mango Studio"].map(
                (l) => (
      ...
      <section id="how-we-think" className="relative mx-auto max-w-7xl px-6 py-24">
        ...
        <p className="mt-3 max-w-2xl text-muted-foreground">
          Three things we hear every week. Three things we fix.
        </p>

        <div className="mt-12 grid gap-5 md:grid-cols-3">
          {[
            {
              pain: "Your website is slow and your developer is missing.",
              fix: "We rebuild it — and stay to keep it healthy.",
              n: "01",
            },
            {
              pain: "You have 4 logins for billing, CRM, and WhatsApp.",
              fix: "We give you one system. One dashboard.",
              n: "02",
            },
            {
              pain: "Automation sounds great but no one sets it up properly.",
              fix: "We actually do it. Then we test it. Then we test it again.",
              n: "03",
            },
          ].map((c) => (
            <motion.div
              key={c.n}
              {...fadeUp}
              className="lift relative overflow-hidden rounded-2xl border border-hairline bg-card p-7"
            >
              <span className="absolute right-5 top-5 font-display text-5xl font-bold text-muted-foreground/20">
                {c.n}
              </span>
      ...
      <section className="relative border-y border-hairline bg-surface/30">
        <div className="mx-auto max-w-7xl px-6 py-24">
          <motion.div {...fadeUp} className="flex flex-wrap items-end justify-between gap-4">
            ...
            <Link to="/services" className="font-display text-sm text-cyan hover:underline">
              All services →
            </Link>
          </motion.div>
            ...
            {[
              {
                ...
                price: "₹3k – ₹10k",
                best: "Restaurants, agencies, creators",
                line: "Fast, fixable, owned by you.",
              },
              {
                icon: "⚙️",
                title: "Business Systems",
                price: "₹40k – ₹2L",
                best: "Schools, clinics, real estate",
                line: "CRM + billing + ops in one.",
              },
              {
                icon: "🤖",
                title: "Automation & Integrations",
                price: "₹2k – ₹40k",
                best: "Anyone tired of copy-paste",
                line: "WhatsApp, sheets, AI — wired up.",
              },
            ].map((s) => (
              <motion.div
                key={s.title}
                {...fadeUp}
                className="lift group rounded-2xl border border-hairline bg-card p-7"
              >
          ...
          <motion.p {...fadeUp} className="mt-8 text-muted-foreground">
            ...
            <a href="https://wa.me/9719203955" className="text-cyan hover:underline">
              WhatsApp us
            </a>
            . We build custom stuff too.
          </motion.p>
        </div>
      </section>
      ...
      <section className="relative mx-auto max-w-5xl px-6 py-28 text-center">
        ...
        <motion.h2
          {...fadeUp}
          className="mt-4 font-display text-3xl font-bold md:text-5xl leading-tight"
        >
          We <span className="text-cyan">talk</span> (no pressure). We{" "}
          <span className="text-pink">build</span> (fast). You{" "}
          <span className="underline decoration-cyan decoration-4 underline-offset-4">launch</span>{" "}
          (happy).
        </motion.h2>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-5xl px-6 py-24">
          <motion.div
            {...fadeUp}
            className="rounded-3xl border border-hairline bg-gradient-to-br from-pink/10 via-card to-cyan/5 p-10 md:p-14"
          >
            ...
            <div className="mt-6 space-y-4 text-lg text-foreground/90 md:text-xl">
              ...
              <p className="text-muted-foreground">
                If that sounds boring to you — we're not a match. If it sounds refreshing — let's
                talk.
              </p>
            </div>
            <Link
              to="/contact"
              className="wiggle mt-8 inline-flex items-center gap-2 rounded-full bg-foreground px-6 py-3 font-display text-sm text-background hover:bg-cyan"
            >
              Let's talk →
            </Link>
          </motion.div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-24">
        <motion.div {...fadeUp} className="flex items-end justify-between flex-wrap gap-4">
          ...
          <Link to="/work" className="font-display text-sm text-cyan hover:underline">
            Full portfolio →
          </Link>
        </motion.div>
        <div className="mt-12 grid gap-5 md:grid-cols-3">
          {[
            {
              tag: "Automation",
              title: "Restaurant WhatsApp Booking",
              stat: "47 signups",
              sub: "in 30 days",
            },
            {
            ...
            <motion.article
              ...
              className="lift group rounded-2xl border border-hairline bg-card p-7"
            >
              <span className="text-xs font-display uppercase tracking-widest text-pink">
                {p.tag}
              </span>
        ...
        <p className="mt-8 text-sm text-muted-foreground">
          We're new. Our portfolio is growing. Every client becomes a case study.
        </p>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-6 pb-24">
        <motion.div
          {...fadeUp}
          className="overflow-hidden rounded-3xl border border-hairline bg-card"
        >
          <div className="marquee-track flex gap-12 whitespace-nowrap py-6 font-display text-3xl">
            {Array.from({ length: 2 }).flatMap((_, i) =>
              [
                ...
                <span key={`${i}-${t}`} className="text-foreground/80">
                  {t}
